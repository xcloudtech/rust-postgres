...
use postgres_protocol::message::replication::LogicalReplicationMessage::{Begin, Commit, Insert};
use postgres_protocol::message::replication::ReplicationMessage::*;
use postgres_protocol::message::replication::TupleData;
...
async fn test_replication() {
    // form SQL connection
    let conninfo = "host=127.0.0.1 port=5432 dbname=postgres user=root password=root replication=database";
